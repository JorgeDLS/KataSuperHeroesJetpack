...
class MainActivityTest : AcceptanceTest<MainActivity>(MainActivity::class.java) {
    ...
    private fun givenThereAreSomeSuperHeroes(
        ...
        whenever(repository.getAllSuperHeroes()).thenReturn(singleValueLiveData(superHeroes.toPagedList()))
        return superHeroes
    }

    private fun givenThereAreNoSuperHeroes() {
        whenever(repository.getAllSuperHeroes()).thenReturn(singleValueLiveData(emptyList<SuperHero>().toPagedList()))
    }
